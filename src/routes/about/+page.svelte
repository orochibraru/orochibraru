...
<Meta
	title="About: a self-taught engineer who is done paying rent on software"
	description="Ten years self-taught, building free self-hosted tools under a weeb handle. How these projects get built, what AI actually does here, and why a pricing page makes me angry enough to rewrite the thing."
	path="/about"
	ogType="profile"
	trail={[["About", "/about"]]}
	{structuredData}
...
<main class="mx-auto max-w-page px-6">
	<article class="prose">
		...
		<section class="mb-22.5">
			<h2 class="mb-5 text-2xl font-bold tracking-[-.02em]">The name</h2>
			<p>
				The handle is a weeb name and the picture is a cartoon, and both are deliberate. I&rsquo;d
				rather what I ship got judged than who shipped it. My legal name adds nothing to a
				Dockerfile. It also means none of this is a personal brand play. There&rsquo;s no
				newsletter, no course, no consulting funnel at the end of the page.
			</p>
			<p class="mt-5">
				And I&rsquo;ll admit the irony is most of the appeal: infrastructure that people run in
		...
		<section class="mb-22.5">
			<h2 class="mb-5 text-2xl font-bold tracking-[-.02em]">How this gets built</h2>
			<p>
			...
			<p class="mt-5">I use AI to write software. Not in the way that sentence has come to mean.</p>
			<p class="mt-5">
				...
				pattern that&rsquo;s already documented three times, converting a type definition I could
				type out myself but would resent. Chores. The parts of this job that are typing, not
				thinking.
			</p>
			<p class="mt-5">
				<strong>The core logic is mine. The ideas are all mine.</strong>
				The architecture, the data model, the trade-offs, the awkward part in the middle that took
				three attempts: that&rsquo;s me, and it&rsquo;s the part I&rsquo;d defend line by line at a
				whiteboard. An intern doesn&rsquo;t get to decide what the product is.
			</p>
			<p class="mt-5">
				What doesn&rsquo;t ship is slop. If I can&rsquo;t explain why a function exists, it
				doesn&rsquo;t go in. Generated code gets read, cut down, and usually rewritten before it
				lands, same as a junior&rsquo;s PR. The tool changed how fast I get through the boring 70%.
				It didn&rsquo;t change who&rsquo;s responsible for the other 30%, or for all of it when it
				breaks at 3am.
			</p>
		</section>

		<section class="mb-22.5">
			<h2 class="mb-5 text-2xl font-bold tracking-[-.02em]">The part some of you will hate</h2>
			<p>
				...
				over one sentence. That&rsquo;s fine, genuinely. I&rsquo;d rather say it plainly on my own
				site than have it treated as something I hid, and I&rsquo;m not going to soften it in a
				README to keep a star.
			</p>
			<p class="mt-5">So here is the trade-off, stated straight.</p>
			<p class="mt-5">
			...
			<p class="mt-5">
				So it gets delegated, and what&rsquo;s left is the part that actually needed a person: what
				the thing is, how it&rsquo;s shaped, what it deliberately refuses to do, and every decision
				you could reasonably argue with me about. That&rsquo;s where the evenings go. The
				alternative here isn&rsquo;t a purer version of these projects. The alternative is that most
				of them don&rsquo;t exist.
			</p>
			<p class="mt-5">
			...
			<p class="mt-5">
				While I&rsquo;m being clear about what this is for: it isn&rsquo;t recognition, and it
				certainly isn&rsquo;t approval.
				<strong>I write this software because I run this software.</strong>
				It sits on my hardware, I use it every day, and that alone is what justifies the hours and
			...
			<p class="mt-5">
				...
				that is genuinely fine: don&rsquo;t use it. Too bad for you. I use it, it works, and
				it&rsquo;s stable enough for everything I trust it with, in no small part thanks to test
				suites the same intern wrote. That&rsquo;s good enough for me. If it turns out to be good
				enough for you too, then that&rsquo;s fucking great.
			</p>
		</section>

		<section class="mb-22.5">
			<h2 class="mb-5 text-2xl font-bold tracking-[-.02em]">Why all of it is free</h2>
			<p>
				Two answers. The boring one first: <strong>I don&rsquo;t need the money.</strong> That day
				job pays well, and nothing on this site has to earn its keep. That matters more than it
				sounds. Software that doesn&rsquo;t need revenue never needs to grow, convert, retain, or
				justify itself in somebody&rsquo;s quarterly review. There is no tier to invent, because
				there is no number anyone is asking me to move.
			</p>
			<p class="mt-5">
				The second answer is that I&rsquo;m picky. Annoyingly, unproductively picky. I notice the
				loading state that flashes, the setting that silently doesn&rsquo;t persist, the modal that
			...
			<p class="mt-5">
				So I was already cynical about software. Then there&rsquo;s the pricing page.
			</p>
			<p class="mt-5">
				A pricing page is where the cynicism stops being funny and turns into actual anger, and
				it&rsquo;s always the same story. You find a good tool. It&rsquo;s free, or nearly, and it
			...
			<p class="mt-5">
				...
				years ago and has shipped nothing since but a redesign. Telemetry I didn&rsquo;t agree to,
				so the thing I&rsquo;m paying for can study me and sell what it learns. An alert when my own
				disk fills up, gated behind Pro (or worse, fucking Enterprise).
			</p>
			<p class="mt-5">
				And the part that actually gets me: none of it is really about the money. I&rsquo;d pay for
				good software. I have, plenty of times, gladly. What I won&rsquo;t do is
				<strong>rent permission to use my own machine</strong>. That&rsquo;s the line. The moment
				your subscription lapsing turns my drive read-only, my files aren&rsquo;t mine and never
				were. That isn&rsquo;t a product, it&rsquo;s a hostage arrangement with a nice onboarding
				flow.
			</p>
			<p class="mt-5">
				...
				need me. Fork it and carry on. That&rsquo;s the whole point of giving it away instead of
				selling it.
			</p>
		</section>
		...
		<section class="mb-22.5">
			<div class="mb-7 flex items-baseline gap-4">
				<h2 class="text-2xl font-bold tracking-[-.02em]">Elsewhere</h2>
