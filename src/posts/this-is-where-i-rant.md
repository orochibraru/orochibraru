...
"sorry for the long silence", then a dead domain. But I kept writing the same
paragraph into READMEs where nobody would ever read it, and a README is a bad
place to be angry.
...
Mostly the things that annoy me enough to write them down.
...
In Markdown, in a file, in the repo, like everything else here. It builds to
static HTML with the rest of the site. There is no CMS, no database, and nothing
to log in to.

> If a piece of software needs an account to publish a paragraph, it has already
> lost.

That is the whole setup. Now let me go find something to be annoyed about.
